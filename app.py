...
def display_prediction(
    ...
    with st.spinner(
        "🔄 PlantDoctor is analyzing the leaf..."
    ):
...
def main():
    ...
    with st.sidebar:
        ...
        st.caption(
            "PlantDoctor uses artificial intelligence "
            "to classify plant leaf images."
        )
    ...
    with tab1:
        ...
        st.write(
            "Take a clear picture of the plant leaf."
        )
    ...
    with tab3:
        ...
        st.markdown(
            ...
            The model was trained using plant leaf images
            and uses **EfficientNetB4** with transfer
            learning.
            ...
            1. Take a photo of a plant leaf, or upload
               an existing image.
            2. PlantDoctor resizes the image to the
               model's required input size.
            3. The AI analyzes the image.
            4. The predicted class is displayed.
            5. The confidence score and top predictions
               are shown.

            ### ⚠️ Important

            PlantDoctor provides an AI-based prediction.
        ...
        # Show classes from class_names.txt
